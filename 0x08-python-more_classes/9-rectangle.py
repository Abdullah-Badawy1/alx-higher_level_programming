...
class Rectangle:
    ...
    instances, a method to compare the sizes of two Rectangle instances, and a
    ...
    def square(cls, size=0):
        ...
        This class method facilitates the creation of a square, which is a
        special case of a rectangle where the width and height are equal.
