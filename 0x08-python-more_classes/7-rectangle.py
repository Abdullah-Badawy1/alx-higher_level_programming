#!/usr/bin/python3
"""Module 7-rectangle for Holberton Python project 0x08 task 7.

This module defines a Rectangle class with additional functionality to keep
track of the number of instances and customizable print symbols for the
...
class Rectangle:
    ...
    the number of instances and allowing for a customizable symbol for the
    string representation. It provides methods to calculate the area and
    perimeter, and mechanisms to represent the object as a string for printing
    or as a string of code that can recreate the object.
